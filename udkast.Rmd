...
Intuitionen bag regressionstræet er, at træningsdata gentagne gange opdeles i mindre dele. De enkelte knuder i træet illustrerer denne opdelingsproces idet der til de enkelte knuder hører en mindre model, som netop splitter data op i mindre dele ved at fremsætte nye "spørgsmål", der skal besvares binært. Denne proces kaldes segmentering, og er relativ simpel ift. andre algoritmer. Segmentering  giver intutiv fortolkning af modellen, og kan nemt fremstilles grafisk. Det er naturligvis muligt at udarbejde et beslutningstræ med lige så mange knuder, som der findes observationer i træningsdata. Dette svarer til at forudsigelserne og observationerne i træningsdata konvergere mod 0 mål ved kvadratroden af kvadratafvigelsesgennemsnittet (RMSE). Dette vil gøre modellens beskrivelse af træningsdata meget nøjagtigt, men vil dog gøre modellen ude af stand til at give præcise forudsigelser på ny data, da modellen ville være overfittet. Derfor er det vigtigt, at vælge et optimalt antal knuder. Der findes forskellige metoder til udvælgelsen af knuder, heriblandt kryds-valideringsmetoden, som ofte giver mere robuste resultatter end den mere simple valideringsmetode. På trods af dette, og at kryds-validering er standardmetoden i algoritmepakken, benyttes her den mere simple validering. Årsagen til dette er valideringsmetoden giver mulighed for grafisk, at forstå udvælgelsen af knuder.

##Validering
Indledningsvist udtrækkes halvdelen af observationerne, på tilfældigvis, i det oprindelige datasæt. Udtrækket bliver brugt som træningsdata, mens den resterende del af data benyttes til validitets, også kaldes testdata. Dernæst udarbejdes et stort regressionstræ, som beskæres indtil det optimale under-træ opnås. Det optimale under-træ er det under-træ, som mindsker RMSE mellem forudsigelserne og observationerne i testdata. Ved denne process frembringes et regressionstræ som består af 8 knuder. Dette fremgår af grafen nedenfor, hvor RMSE er en funktion af knuder. For testdata har RMSE har globalt minimum i 8, mens RMSE for træningsdata konvergere mod 0, præcis som ventet. Det udtrykker altså en balancen mellem bias ved lille et træ og overfitting ved et stort træ. 

Kryds-valideringmetoden minder meget om ovenstående metode, dog betyder kryds-validering at træningdata opdeles til flere undersæt, og derved skal flere modeller estimeres og beskæres. Dette kan være beregningstungt, derfor opstilles en cost-funktion for RMSE, hvor et kompleksitetsled formuleres. Kompleksitetsleddet er produktet af en positivt staf-koefficient og antal af knuder. Ved kryds-validering estimeres blot en sekvens af modellerne, givet en række forskellige staf-koefficienter. For hver staf-keofficient vælges det  under-træ, som minimere cost-funktionen  
...
Dette betyder at beslutningstræet udarbejdes på baggrund af træningsdatasættet og derefter testes på testdata, således at vi kan vurdere modellen.  cross validation og benyttes    
